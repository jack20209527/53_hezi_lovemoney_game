...
class LoadingUtil {
    ...
    static show(message = 'Loading...', subMessage = 'please wait a moment') {
      ...
      // 创建蒙层元素
        ...
        overlayElement.className = 'fixed inset-0 z-40 bg-black/80'; // 半透明黑色背景 50
        document.body.appendChild(overlayElement);

        // 创建 Loading 元素
        const loadingElement = document.createElement('div');
        loadingElement.className = 'fixed inset-0 flex items-center justify-center z-50'; // z-index: 50
        ...
        instance.overlayElement = overlayElement; // 保存蒙层元素
